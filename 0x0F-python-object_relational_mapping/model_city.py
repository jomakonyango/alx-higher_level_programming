...
Python file similar to model_state.py that
...
of an auto-generated, unique integer,
    ...
    - class attribute state_id that represents a
    column of an integer, can’t be null and is a foreign key to states.id
    """
